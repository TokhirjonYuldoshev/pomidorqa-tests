...
Уровни проверок интерпретируются по силе доказательства: browser E2E подтверждает пользовательское
...
Требование считается `automated`, если для него есть автоматизированная проверка на подходящем
уровне и связь «требование → тест» явно зафиксирована.
